...
public class GramaticaSelect implements Gramatica {
    ...
    public Select analizar(Sentencia raiz, FlujoTokens flujoTokens) {
        ...
        //tipo de retorno.....
        if (lexema.getToken().equals("function")) {
//            metodo.setRetorno(lexema);
            ...
            //nombre del metodo....
            if (lexema.getToken().equals("select")) {
            ...
            if (lexema.getTipoLexema().equals("parentesis abierto")) {
                ...
                if (lexema.getToken().equals("table")) {
                    lexema = flujoTokens.avanzar();

                    if (lexema.getToken().equals("Identificador")) {
                        lexema = flujoTokens.avanzar();
                        if (lexema.getToken() == null) {
                            throw new SintacticException(new Lexema("", ""), "se espera un identificador");
                        }
                        //lista de parametros......
